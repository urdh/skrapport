...
\begin{document}
    ...
    \changes{0.12a}{Use of TOC depth above 3 is now unsupported}
...
\cs_new:Npn\dim_set_to_abstract_or_email_wd:N#1{
    \dim_set_to_wd:Nn\l_tmpa_dim
        {\bfseries\abstractname\__skrapport_abstract_style:}
    \dim_set_to_wd:Nn\l_tmpb_dim
        {\bfseries\__skrapport_Email_word:\__skrapport_abstract_style:}
    \bool_if:NTF\g__skrapport_abstract_used
