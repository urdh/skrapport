...
\cs_set:Nn\__skrapport_generic_section:nnnnn{
    \__skrapport_pre_section:x{\use:c{c__skrapport_#1_pre_skip}}
    \IfBooleanTF#3{
        \__skrapport_section_star:xxn
            {\use:c{c__skrapport_#1_indent_dim}}
            {\use:c{__skrapport_#1_style:}}
            {#5}
    }{
        \IfNoValueTF{#4}{
    ...
    \__skrapport_post_section:x{\use:c{c__skrapport_#1_post_skip}}
}
\end{MacroCode}
    \end{macro}
