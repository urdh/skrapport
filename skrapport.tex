...
\ProvidesClass{skrapport}%
    [2013/04/01 v0.11 Skånings rapportklass]
\end{MacroCode}
...
\end{MacroCode}
    ...
    \begin{option}{font}{nofont, kpfonts, lmodern, palatino, minion, skdoc}
...
\DeclareVoidOption{skdoc}{\skrapport@SetupFont}
...
\IfStrEq{\skrapport@titles}{bf}{%
    ...
    \let\@titstyle\sffamily%
}{%
    \let\@titstyle\rmfamily%
}}
\end{MacroCode}
    \end{macro*}
