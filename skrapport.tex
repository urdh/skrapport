...
\end{MacroCode}
    ...
    clone and possibly more stuff later. Maybe we should extract the
    counter macros to its own package or at least its own file?
...
\end{MacroCode}
    \end{macro}
    \begin{macro}{\ctr_use_arabic:n}[1]
        {Counter name}
\begin{MacroCode}{class}
\cs_new:Npn\ctr_use_arabic:n#1{
    \exp_args:Nx\int_to_arabic:n{\ctr_use:n{#1}}
}
\end{MacroCode}
    \end{macro}
    \begin{macro}{\ctr_use_alph:n}[1]
        {Counter name}
\begin{MacroCode}{class}
\cs_new:Npn\ctr_use_alph:n#1{
    \exp_args:Nx\int_to_alph:n{\ctr_use:n{#1}}
}
\end{MacroCode}
    \end{macro}
    \begin{macro}{\ctr_use_Alph:n}[1]
...
\end{MacroCode}
    \end{macro}
%    \begin{macro}{\ctr_use_binary:n}[1]
%        {Counter name}
%\begin{MacroCode}{class}
%\cs_new:Npn\ctr_use_binary:n#1{
%    \exp_args:Nx\int_to_binary:n{\ctr_use:n{#1}}
%}
%\end{MacroCode}
%    \end{macro}
%    \begin{macro}{\ctr_use_hex:n}[1]
%        {Counter name}
%\begin{MacroCode}{class}
%\cs_new:Npn\ctr_use_hex:n#1{
%    \exp_args:Nx\int_to_hexadecimal:n{\ctr_use:n{#1}}
%}
%\end{MacroCode}
%    \end{macro}
%    \begin{macro}{\ctr_use_octal:n}[1]
%        {Counter name}
%\begin{MacroCode}{class}
%\cs_new:Npn\ctr_use_octal:n#1{
%    \exp_args:Nx\int_to_octal:n{\ctr_use:n{#1}}
%}
%\end{MacroCode}
%    \end{macro}
    \begin{macro}{\ctr_use_roman:n}[1]
        {Counter name}
\begin{MacroCode}{class}
\cs_new:Npn\ctr_use_roman:n#1{
    \exp_args:Nx\int_to_roman:n{\ctr_use:n{#1}}
}
\end{MacroCode}
    \end{macro}
    \begin{macro}{\ctr_use_Roman:n}[1]
...
\end{MacroCode}
    \end{macro}
    \begin{macro}{\ctr_use_fn:n}[1]
        {Counter name}
\begin{MacroCode}{class}
\cs_new:Npn\ctr_use_fn:n#1{
    \exp_args:Nxnn\int_to_symbols:nnn{\ctr_use:n{#1}}{9}{
        {1}{*}
        {2}{\dagger}
        {3}{\ddagger}
        {4}{\mathsection}
