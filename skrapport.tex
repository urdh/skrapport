...
\begin{document}
    ...
    \DescribeMacro\maketitle[hide={date,email}]
    ...
    The optional argument is a key-value list with only one valid
    entry, \opt*{hide}. This entry accepts a comma-separated list in
    which the values \opt*{date} and \opt*{email} are interpreted
    as instructions to hide the corresponding entry from the front page.
...
\end{MacroCode}
    ...
    \changes{0.12a}{Added optional key-value argument}
