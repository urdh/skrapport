...
\end{MacroCode}
    \end{macro*}
    \begin{macro*}{\ctr_gzero:n}
\cs_new:Npn\ctr_gzero:n#1{
    \int_gzero:c{c@#1}
}
    \end{macro*}
    \begin{macro*}{\ctr_gset:nn}
\cs_new:Npn\ctr_gset:nn#1#2{
    \int_gset:cn{c@#1}{#2}
}
    \end{macro*}
    \begin{macro*}{\ctr_incr:n}
\cs_new:Npn\ctr_incr:n#1{
    \int_gincr:cn{c@#1}
}
    \end{macro*}
...
\end{MacroCode}
    ...
    macro.
    \begin{macro*}{\__skrapport_email:n}
...
\end{MacroCode}
    ...
    \begin{macro}{\section}
\begin{MacroCode}{class}
\DeclareDocumentCommand\section{}{ % !!! magic happens
...
\begin{MacroCode}{class}
\DeclareDocumentCommand\subsection{}{ % !!! magic happens
...
\begin{MacroCode}{class}
\DeclareDocumentCommand\subsubsection{}{ % !!! magic happens
...
\begin{MacroCode}{class}
\DeclareDocumentCommand\paragraph{}{ % !!! magic happens
...
\begin{MacroCode}{class}
\DeclareDocumentCommand\subparagraph{}{ % !!! magic happens
