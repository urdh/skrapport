...
\begin{document}
    ...
    In general, the class defines the same macros as the \pkg{article} class.
    ...
    In \texttt{twocolumn} mode, the package defines an environment \opt{onecol}
      which typesets its contents in a single column. Additionally, it redefines
      \env{figure} and \env{table} as non-floats, leaving the starred versions
      intact.
