...
\end{MacroCode}
    ...
    \begin{macro*}{\__skrapport_eg_word:}
    \begin{macro*}{\__skrapport_ie_word:}
    \begin{macro*}{\__skrapport_etc_word:}
    \begin{macro*}{\__skrapport_cf_word:}
    \begin{macro*}{\__skrapport_viz_word:}
...
\begin{MacroCode}{class}
            ...
            \cs_gset:Nn\__skrapport_eg_word:{e.g.}
            \cs_gset:Nn\__skrapport_ie_word:{i.e.}
            \cs_gset:Nn\__skrapport_etc_word:{etc.}
            \cs_gset:Nn\__skrapport_cf_word:{cf.}
            \cs_gset:Nn\__skrapport_viz_word:{viz.}
...
\end{MacroCode}
    \end{macro}
    \begin{macro}{\__skrapport_italic_and_peek_punctuation:n}
    \begin{macro*}{\__skrapport_italic_and_peek_punctuation:x}
\begin{MacroCode}{class}
\cs_new_nopar:Nn\__skrapport_italic_and_peek_punctuation:n{
    \mbox{\emph{#1}}
...
\cs_generate_variant:Nn\__skrapport_italic_and_peek_punctuation:n{x}
\end{MacroCode}{class}
    \end{macro*}
    \end{macro}
    \begin{macro}{\eg}
...
\DeclareDocumentCommand\eg{}{
    \__skrapport_italic_and_peek_punctuation:x{
        \__skrapport_eg_word:
    }
}
\end{MacroCode}{class}
