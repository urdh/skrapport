...
\begin{MacroCode}{class}
    draft .bool_set:N = \g__skrapport_draft_bool,
...
\begin{MacroCode}{class}
    ...
    indent / false .code:n = {\__skdoc_setup_parskip:},
...
\begin{MacroCode}{class}
    color .bool_set:N = \g__skrapport_color_bool,
...
\begin{MacroCode}{class}
    nomath .choice:,
    nomath / false = .code:n {\__skdoc_setup_math:},
