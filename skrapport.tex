...
\end{MacroCode}
    ...
    \changes{0.12a}{Now uses \cs{__skrapport_toc_line:nnnnn}}
\begin{MacroCode}{class}
...
\end{MacroCode}
    ...
    \changes{0.12a}{Now uses \cs{__skrapport_toc_line:nnnnnn}}
\begin{MacroCode}{class}
...
\end{MacroCode}
    ...
    \changes{0.12a}{Changed style to match \pkg{skdoc}}
\begin{MacroCode}{class}
