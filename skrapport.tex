...
%    \subsubsection{Basic bibliography support}
    ...
    typesets the comment in a \cs{marginnote}.
...
\end{MacroCode}
    ...
    definitions.
\begin{MacroCode}{class}
\RequirePackage{calc,isodate,multicol,marginnote}
\end{MacroCode}
...
\end{MacroCode}
    ...
    \changes{0.12d}{Use \cs{marginnote} instead of \cs{marginpar}}
\begin{MacroCode}{class}
\DeclareDocumentCommand\comment{sm}{
    \IfBooleanTF{#1}
        ...
        {\marginnote{\__skrapport_comment:n{#2}}}
}
\end{MacroCode}
    \end{macro}
    \begin{macro}{\com}
